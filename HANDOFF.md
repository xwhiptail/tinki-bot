...
- Last known good verification: `.venv/bin/python -m pytest -q` locally (`320 passed`) after softening Tinki's personality prompts, plus focused prompt coverage and `TestNoMojibake`
