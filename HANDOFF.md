...
- Last known good verification: `python -m pytest -q` locally (`289 passed`) after adding the erotic/spicy request roast trap, plus `python -m pytest --collect-only -q` and focused AI listener coverage
