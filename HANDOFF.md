...
- Last known good verification: `python -m pytest -q` locally (`293 passed`) after adding deterministic `DRG` context handling, plus `python -m pytest --collect-only -q` and focused AI listener coverage
