...
- Last known good verification: `.venv/bin/python -m pytest -q` locally (`325 passed`) after adding plain-text Tinki/the-bot auto replies, plus focused listener coverage, collect-only, `TestNoMojibake`, and `git diff --check`
